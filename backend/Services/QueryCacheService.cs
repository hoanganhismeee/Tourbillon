...
public class QueryCacheService
{
    ...
    // v6: the concierge's candidate pool fuses BM25F with vector search, so a v5 entry holds a
    // ranking the current pipeline no longer produces.
    ...
    private const string DefaultPipelineVersion = "v6-hybrid-mpnet768-haiku";
