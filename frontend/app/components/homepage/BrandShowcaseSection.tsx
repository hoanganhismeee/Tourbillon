...
export default function BrandShowcaseSection() {
  ...
  return (
    <div className="container mx-auto px-8 sm:px-12 lg:px-16 xl:px-20 max-w-7xl">
      ...
      {/* Section heading */}
      <ScrollFade>
        <h2 className="text-5xl font-playfair font-bold text-center mb-15 mt-32 text-[#f0e6d2]">
          Explore Our Brands
        </h2>
      </ScrollFade>
      ...
      <section className="mb-20">
        <ScrollFade>
          <h3 className="text-5xl font-playfair font-bold text-center mb-20 text-[#f0e6d2]">
      ...
      <section className="mb-32">
        <ScrollFade>
          <h3 className="text-5xl font-playfair font-bold text-center mb-10 text-[#f0e6d2]">
            Explore More Brands
          </h3>
        </ScrollFade>
