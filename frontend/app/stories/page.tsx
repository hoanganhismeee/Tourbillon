...
// Founding story + a featured catalogue strip; a pocket watch is locked to the
// page corner so its scroll-driven hands stay visible the whole way down.
...
export default function StoriesPage() {
  return (
    <main className="relative overflow-hidden pt-10 text-white">
      {/* Pocket watch locked to the corner — hands wind faster as you scroll */}
      <div className="pointer-events-none fixed bottom-6 right-6 z-40 hidden flex-col items-center gap-2 xl:flex">
        <PocketWatch size={150} variant="champagne" />
        <p className="font-playfair text-[11px] italic tracking-wide text-[#bfa68a]/55">
          scroll to wind it
        </p>
      </div>
