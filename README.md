...
- **Watch DNA**: Personalised taste fingerprint built silently from browsing behaviour — watches viewed, brands explored, collections visited, and search queries. The AI synthesises this into a taste profile (preferred brands, materials, dial colours, price range, case size) and surfaces it on the account page as a plain-English summary. Anonymous visitors are tracked from the first page view and their data merges into their account on sign-in. Users can view and override their profile at any time. The same scoring engine floats preferred watches to the top of every listing.
