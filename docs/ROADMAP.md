...
- Admin endpoints: `POST /api/admin/query-cache/seed` (115 pre-defined queries), `GET /api/admin/query-cache/status`, `DELETE /api/admin/query-cache`
